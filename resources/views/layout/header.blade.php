...
<header class="header_area">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="top_right text-right">
                            <ul>
                                ...
                                <li class="language"><a href="#"><img src="{{asset('assets/img/logo/language.png')}}" alt="">en-gb<i class="ion-ios-arrow-down"></i></a>
                                    <ul class="dropdown_language">
                                        <li><a href="#"><img src="{{asset('assets/img/logo/language.png')}}" alt=""> English</a></li>
                                        <li><a href="#"><img src="{{asset('assets/img/logo/language2.png')}}" alt=""> Germany</a></li>
                                    </ul>
                                </li>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-3 col-md-6">
                    <div class="logo">
                        <a href="{{route('web.home')}}"><img src="{{asset('assets/img/logo/logo.png')}}" alt=""></a>
                    </div>
                </div>
    ...
    <div class="mini_cart">
        ...
        <div class="cart_item">
            <div class="cart_img">
                <a href="{{route('web.home')}}"><img src="{{asset('assets/img/s-product/product.jpg')}}" alt=""></a>
            </div>
            <div class="cart_info">
        ...
        <div class="mini_cart_footer">
            <div class="cart_button">
                <a href="{{route('web.cart')}}">View cart</a>
            </div>
            <div class="cart_button">
